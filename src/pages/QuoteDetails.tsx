        ...
        <div className="text-center py-12 bg-white rounded-lg shadow">
          ...
          <div className="mt-6">
            <button
              ...
              className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-none shadow-sm text-white bg-blue-600 hover:bg-blue-700"
            >
              Go Back
            </button>
          </div>
      ...
      <div className="bg-white shadow-lg rounded-none overflow-hidden">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              ...
              <PDFDownloadLink
                ...
                className="flex items-center px-4 py-2 bg-white text-blue-600 rounded-none hover:bg-blue-50"
              >
              ...
              {user?.role === 'manager' && (
                <>
                  ...
                  <button
                    ...
                    className="flex items-center px-4 py-2 bg-red-500 text-white rounded-none hover:bg-red-600"
                  >
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="flex space-x-2">
                    {quote.status === 'draft' && user?.role === 'manager' && (
                      <button
                        ...
                        className="flex items-center px-3 py-2 bg-green-600 text-white rounded-none hover:bg-green-700"
                      >
                    ...
                    {quote.status === 'sent' && (
                      <>
                        ...
                        <button
                          ...
                          className="flex items-center px-3 py-2 bg-red-600 text-white rounded-none hover:bg-red-700"
                        >
            ...
            {/* Route */}
            <div className="md:col-span-2 bg-gray-50 p-4 rounded-none">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {quote.cargoDetails.map((item, index) => (
                      <tr key={index}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{item.grossWeight} kg</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{item.volume} m³</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {quote.costs.map((cost, index) => (
                      <tr key={index}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{cost.quantity}</td>
